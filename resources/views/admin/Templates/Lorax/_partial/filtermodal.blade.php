<div class="modal fade" id="filter-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['onsubmit'=>'filterFunction($(this));return false;', 'class'=>""]) !!}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary m-btn" data-dismiss="modal" data-bs-dismiss="modal" data-bs-dismiss="modal">
                    {{__('Close')}}
                </button>
