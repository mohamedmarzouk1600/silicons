<x-admin-card :title="__('Registered patients')" class="col-sm-6">
    <div data-id="registered_patients" data-route="{{ route('admin.statistics.registered_patients', null, false) }}">
        <form class="data-chart-form" id="registered_patients_form">
