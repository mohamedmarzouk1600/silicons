...
(function(window, document, $) {
  ...
  var countries = new Bloodhound({
    ...
    prefetch: '../../../admin-assets/data/countries.json'
  ...
  var bestPictures = new Bloodhound({
    ...
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../../admin-assets/data/films/post_1960.json',
    remote: {
      url: '../../../admin-assets/data/films/queries/%QUERY.json',
      wildcard: '%QUERY'
    }
  });
  ...
  var nflTeams = new Bloodhound({
    ...
    prefetch: '../../../admin-assets/data/nfl.json'
  });
  ...
  var nbaTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../../admin-assets/data/nba.json'
  });

  var nhlTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../../admin-assets/data/nhl.json'
  });
