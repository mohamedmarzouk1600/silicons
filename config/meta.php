...
return [
    ...
    */
    ...
    |
    */
	'title'	=> app()->getLocale() == 'en' ? 'app' : 'app',
    ...
    |
    */
	'description' => app()->getLocale() == 'en' ? 'app ' : 'app ',
    ...
    |
    */
	'image' => config('settings.static_url') . '/images/logo.png',
    ...
    |
    */
	'author' => app()->getLocale() == 'en' ? 'app' : 'app',
    ...
    |
    */
	'geo_region' => app()->getLocale() == 'en' ? 'egypt' : 'مصر', //e.g: Lagos
    ...
    */
    ...
    |
    */
	'keywords' => app()->getLocale() == 'en' ? 'app ' : 'app ',
